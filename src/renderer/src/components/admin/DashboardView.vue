    ...
    >
      ...
      <div class="space-y-3">
        <button
          ...
          :key="action.label"
          class="w-full flex items-center space-x-3 p-4 rounded-xl bg-slate-50 dark:bg-slate-700/50 hover:bg-gradient-to-r hover:from-emerald-500 hover:to-teal-600 hover:text-white transition-all group"
        >
          <svg
