<!-- <template>
  <div class="block h-67 max-w-sm border border-gray-300/60 rounded-lg shadow-xs">
    <div
      class="flex w-full rounded-t-lg justify-center items-center border-b border-b-gray-300/60 text-lg font-bold"
    >
      <input
        type="text"
        class="w-full h-6.5 ps-1 text-center focus:outline focus:outline-blue-500/50 block"
        value="Dalacin 500mg Capsules"
      />
    </div>
    <div>
      <div class="h-24">
        <textarea
          type="text"
          class="w-full h-full p-1 text-lg text-wrap no-scrollbar resize-none focus:outline focus:outline-blue-500/50"
        >
Take one tablet by mouth twice daily for 7 days. Take with food to avoid stomach upset.</textarea
        >
      </div>
      ...
      <div class="flex h-7 gap-2 px-2">
        <div class="flex gap-1">
          ...
          <input
            type="text"
            class="border border-gray-300/60 w-30 h-6.5 ps-1 focus:outline focus:outline-blue-500/50 block"
            value="John Doe"
          />
        </div>
        <div class="flex gap-1">
          ...
          <input
            type="text"
            class="border border-gray-300/60 w-20 h-6.5 ps-1 focus:outline focus:outline-blue-500/50 block"
            value="John Doe"
          />
        </div>
      </div>
      <div class="px-2 py-0.5 text-sm"><strong>2026/03/01 13:20</strong></div>

      <div class="h-11 border-y border-y-gray-300/60">
        <textarea
          type="text"
          class="w-full h-full text-wrap no-scrollbar px-1 text-sm resize-none focus:outline focus:outline-blue-500/50"
        >
May cause dizziness. Avoid operating heavy machinery. Avoid operating heavy machinery.</textarea
        >
      </div>
    </div>

    <div class="flex gap-2 p-2">
      <Button label-id="Remove" color="red" />
      <Button label-id="Update" color="yellow" />
      <Button label-id="Add To Queue" color="green" />
      <Button label-id="Print" color="blue" />
    </div>
  </div>
</template> -->
