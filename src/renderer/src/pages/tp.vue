<template>
  <div class="h-full w-full dark:bg-gray-900 dark:text-white bg-amber-600">
      ...
      >
        <div class="max-w-7xl mx-auto h-full flex flex-col gap-4">
            ...
            <div class="order-last md:order-none">
              <div class="relative w-full">
                ...
                <input
                  ...
                  class="w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
          ...
          <div class="flex-1 overflow-auto">
            <div
              ref="labelsContainer"
              class="flex flex-col md:flex-row md:gap-4 gap-3 pb-4 min-h-full md:overflow-x-auto md:overflow-y-hidden overflow-y-auto overflow-x-hidden"
            >
              <div
              ...
              <div
                ...
                class="flex items-center justify-center w-full text-gray-500 dark:text-gray-400"
              >
...
const getClientLabels = async (id) => {
  const c = await window.api.getClientLabels(id)
  console.log(c)
  labels.value = c
}

const getClient = async (id) => {
  const c = await window.api.getClientById(id)
  console.log(c)
  client.value = c
}
