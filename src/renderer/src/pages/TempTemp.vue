          ...
          <div v-else class="flex-1 overflow-hidden px-6 py-5">
            <div class="grid grid-cols-2 gap-6 h-full">
              ...
              <div class="flex flex-col h-full">
                ...
                <div
                  class="flex-1 border-2 border-gray-200 dark:border-gray-700 rounded-xl overflow-y-auto bg-gray-50 dark:bg-gray-900/50 max-h-96"
                >
                  <div
              ...
              <div class="flex flex-col h-full">
                ...
                <div
                  class="flex-1 border-2 border-blue-200 dark:border-blue-800 rounded-xl overflow-y-auto bg-blue-50/30 dark:bg-blue-900/10 max-h-96"
                >
                  <div
