<template>
  <div class="h-full w-full dark:bg-gray-900 dark:text-white">
    <div
      class="flex fixed top-0 left-0 h-14 w-full border-b border-gray-300/60 dark:border-gray-800/60 shadow-xs items-center px-5 dark:bg-gray-900"
    >
      <div class="flex flex-1 gap-2 items-center">
        <span class="text-lg font-bold">Medication Label</span>
        <span
          :class="[
            queueCount <= 0
              ? 'bg-red-100 text-red-700 ring-1 ring-inset ring-red-700/10 dark:bg-red-900/30 dark:text-red-400 dark:ring-red-400/20'
              : 'bg-blue-100 text-blue-700 ring-1 ring-inset ring-blue-700/10 dark:bg-blue-900/30 dark:text-blue-400 dark:ring-blue-400/20',
            ' inline-flex items-center align-middle rounded-full px-1.5 py-1 text-xs/none font-medium'
          ]"
        >
          Queue: {{ queueCount }}
        </span>
    ...
    <div
      class="flex fixed top-14 left-0 h-12 w-full shadow-xs items-center px-5 mb-4 gap-x-4 border-b border-gray-300/60 dark:border-gray-800/60 dark:bg-gray-900 dark:text-white"
    >
    ...
    <div
      class="label-container fixed top-26 left-0 w-full h-[calc(100vh-6.5rem)] overflow-auto grid grid-cols-[repeat(auto-fill,350px)] gap-7.5 p-5 justify-center dark:bg-gray-900 dark:text-white"
    >
      <LabelCardV2
...
const moreActions = [
  ...
  {
    label: 'View Queue',
    handler: () => router.push({ name: 'Queue' })
  },
  {
    label: 'Logout',
